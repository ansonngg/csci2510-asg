...
input:
	...
	; Save the base pointers of CacheTags and CacheTimes
	push EBP
	push ESI
	...
	shl EBX, 4
	add EBP, EBX ; EBP contains the address of the first block in the corresponding set with offset
	shr EAX, 5 ; EAX contains the tag
